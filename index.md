...
![Robot arm drawing my initials]({{site.baseurl | prepend: site.url}}./midterm.gif)
<img src="{{site.baseurl | prepend: site.url}}./midterm.gif" alt="Robot arm drawing my initials in space" />
